...
class BottomNode(object):
    ...
    def __init__(self, hibernate_minutes=None, reply_timeout_secs=None):
        ...
        if reply_timeout_secs == None:
            ...
            self.reply_timeout_secs = reply_timeout_secs
    ...
    def start(self):
        ...
        # Send important settings every time we run
        self.um.set_config('SRC', self.srcid)
        self.um.set_config('BND', 0)
        self.um.set_config('FC0', 10000)
        self.um.set_config('BW0', 2000)
        self.um.set_config('PCM', 0)
        self.um.set_config('FML', 200)
        sleep(1)                  
        
        # Don't set the clock from the modem, because the RTC is awesome now.
        ...
        self.logger.info("Waiting {0} seconds for replies".format(self.reply_timeout_secs))
        
        # Wait for replies from the WaveGlider
